...
class Ma12070p : public ma12070p, public modm::I2cDevice<I2cMaster, 2>
{
public:
	/**
	 * Constructor.
	 ...
	 *                   AD1=1, AD0=1 -> 0x23
	 */
	Ma12070p(uint8_t i2cAddress) : I2cDevice<I2cMaster, 2>(i2cAddress)
	{};
	...
	ResumableResult<bool>
	setLimiterThreshold(quarter_decibel_t ch0l, quarter_decibel_t ch0r, quarter_decibel_t ch1l = -144_q_db, quarter_decibel_t ch1r = -144_q_db);
	...
	ResumableResult<bool>
	setChannelVolume(quarter_decibel_t ch0l, quarter_decibel_t ch0r, quarter_decibel_t ch1l = -144_q_db, quarter_decibel_t ch1r = -144_q_db);
...
private:
	...
	constexpr uint16_t
	qdbToRegValue(ma12070p::quarter_decibel_t v)
	{
		return uint16_t(std::clamp((-4 * int16_t(v)) + 96, 0, 672));
	}
};
