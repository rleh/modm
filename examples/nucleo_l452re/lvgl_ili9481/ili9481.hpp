...
protected:
	...
	Command : uint8_t
	{
		...
		SetAddressMode = 0x36,  // MemoryAccessCtrl
		MemoryAccessCtrl = SetAddressMode,
...
class Ili9481 : public Interface, public modm::ColorGraphicDisplay
{
	...
	using Command = ili9481::Command;
public:
	using Orientation = glcd::Orientation;
	using DisplayMode = ili9481::DisplayMode;

	template<typename... Args>
	Ili9481(Args&&... args): Interface(std::forward<Args>(args)...)
	{
    ...
    // TODO implement getPixel for ili9481
	color::Rgb565
...
#include "ili9481_impl.hpp"

#endif //  MODM_ILI9481_HPP
